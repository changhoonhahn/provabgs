...
wave_bins = [(wave < 3600), (wave >= 3600) & (wave < 5500), (wave >= 5500) & (wave < 7410), (wave >= 7410)]
...
for i in range(len(n_pcas)):
    ...
    fpca = os.path.join(dat_dir, 'fsps.%s.v%s.seed%s.w%i.pca%i.hdf5' % (model, version, batches, i, n_pcas[i]))

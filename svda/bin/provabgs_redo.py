...
if target == 'BGS_BRIGHT' and survey == 'sv3': 
    # read healpixs and targetids
    hpixels, targetids = np.loadtxt('/global/cfs/cdirs/desi/users/chahah/provabgs/svda/sv3-bright-BGS_BRIGHT.flagged.20220719.dat', dtype=int, unpack=True, usecols=[0,1])
elif target == 'BGS_FAINT' and survey == 'sv3': 
    # read healpixs and targetids
    hpixels, targetids = np.loadtxt('/global/cfs/cdirs/desi/users/chahah/provabgs/svda/sv3-bright-BGS_FAINT.flagged.20220719.dat', dtype=int, unpack=True, usecols=[0,1])
